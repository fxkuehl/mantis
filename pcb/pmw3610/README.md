# PMW3610 trackball pcb - Mantis Version

## Overview

This module is based on the
[PMW3610 XS module](https://github.com/sadekbaroudi/vik/tree/master/pcb/pmw3610-xs)
by Sadek Baroudi. The schematic is identical. The components are rearranged
to fit my PCB outline. The PMW3610 footprint is modified to make the cutout
slightly smaller, which leaves a bit more PCB material and a wider ground
zone above the sensor. All breakout pins are present but some labels didn't
fit on the back side.

The VIK module certification below is updated to reflect the non-standard
form factor. This module is meant to fit the Mantis v1.0 keyboard and
should be attached to the VIK OUT port of the main PCB with an FFC type A
cable.

## Original notes by Sadek Baroudi
